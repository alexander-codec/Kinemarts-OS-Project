...
firebase.auth().onAuthStateChanged(function(user) {
        if (user) {
			...
			firebase.database().ref('armazenamento/espaço/'  + userId + '/espaçoadquirido').once('value').then(function(snapshot) {
				var jk = snapshot.val();
				if(jk != null){
					$("#menuarmazenamento").prop("href", "meucloud");
				}
			});
		}
});